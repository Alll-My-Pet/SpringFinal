	         		...
	         		<section class="emojiWrite">
		        		<form method="post" >
		        			...
		        			<div class="emoAiCreation">
			        			...
			        			<input type="file" class="emoAI" id="emoAI" name="emoAI" accept="image/*" onchange="previewImage2(event)">
		        			</div>
		        			...
		        			<div class="emoUploadSubmit">
		        				<input type="submit" class="emoUploadSubmitBtn" name="emoUploadSubmitBtn" id="emoUploadSubmitBtn" value="업로드">
		        			</div>
		        		</form>
		        	</section>
				<!-- contents 끝 -->
