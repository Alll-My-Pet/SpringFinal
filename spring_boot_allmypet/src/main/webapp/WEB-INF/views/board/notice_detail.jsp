...
<head>
<meta charset="UTF-8">
<title>공지게시글 상세</title>
<link rel="shortcut icon" type="image/x-icon" href="data:image/x-icon;,">
<link rel="stylesheet" type="text/css"
	href="<c:url value='/css/common.css'/>">
<link rel="stylesheet" type="text/css"
	href="<c:url value='/css/animal/tipboard_detail.css' />" />
<script src="<c:url value='/js/jquery-3.7.1.min.js'/>"></script>
<script src="<c:url value='/js/animal/tip_board_detail.js'/>"></script>
<script>
				...
				<div class="contents">
					<div class="pageInfo">
						<div class="page-title">
							<span class="ctgTitle">공지 게시판</span>
						</div>
					</div>
					<!-- pageInfo 끝 -->
