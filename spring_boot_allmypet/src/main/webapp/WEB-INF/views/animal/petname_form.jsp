...
<link rel="stylesheet" type="text/css"
	href="<c:url value='/css/animal/petname.css'/>">
									...
									<div class="form-container" id="formContainer">
										<table>
											<tr>
												...
												<td><input type="text" id="petType"
													placeholder="예: 개, 도마뱀, 미어캣..." required><br>
												</td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td>
													<button type="button" class="gender-button male" value="수컷">
														<img src="/image/petname/male.png" width="20px" alt="수컷">
													</button>
													<button type="button" class="gender-button female"
														value="암컷">
