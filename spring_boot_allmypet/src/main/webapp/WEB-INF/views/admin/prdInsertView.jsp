	...
	<body>
		...
		<section id="admin_prdinsert">
			<div id="mypage_l">
				<div id="comm_control">
					<span>관리자 페이지</span>
					<a href="/mypage/bookmark_post" class="btn_div"><div id="control_mbl" >상품 추가</div></a>
					<a href="/mypage/bookmark_post" class="btn_div"><div id="control_mbl" >상품 관리</div></a>
					<a href="/mypage/bookmark_gallery" class="btn_div"><div id="control_mbl">이모지 관리</div></a>
					<a href="/mypage/my_post_commnet" class="btn_div"><div id="control_mpc">신고 유저</div></a>
					<a href="/mypage/my_emoji" class="btn_div"><div id="control_mi">신고 글</div></a>
				</div>
			</div>
