package com.spring_boot_allmypet.project.service.ai;
...
public class GreenEyeService {
	public GreenEyeVO greenEye(String imageFilePath) {
		
		GreenEyeVO vo = new GreenEyeVO();
		
		String apiURL = "https://clovagreeneye.apigw.ntruss.com/custom/v1/134/d9e92251c109b59a764e3470f06a8f35a772e344813f7b203ad36aecd89105d8/predict";
		String secretKey = "UmR0TEJhY3NveUVndG9WU2tGS2FhV3VOTlNwdnpQT2E=";
		...
		try {
			...
			// (1) 이미지 파일 base64 인코딩
			byte[] fileContent  =  Files.readAllBytes(new File(imageFilePath).toPath());
