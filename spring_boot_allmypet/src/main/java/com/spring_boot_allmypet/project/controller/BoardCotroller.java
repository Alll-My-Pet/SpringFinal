...
public class BoardCotroller {
    ...
    public String FreeBoardList(@RequestParam(required=false, defaultValue="1") int pageNo,
                               Model model) {
	...
	// 동물보호 
	 @RequestMapping("/board/ProtectBoardList")
	    public String ProtectBoardList(@RequestParam(required=false, defaultValue="1") int pageNo,
	                               Model model) {
